...
const faqs = [
  ...
  { question: "Is my deposit refundable?", answer: "Your deposit fee counts towards your service charge. However, it is non-refundable if you cancel your booking within 48 hours of your appointment date." },
